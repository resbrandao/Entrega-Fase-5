...
public class CartaoEntity {
    ...
    private Collection<CompraProtegidaEntity> pagamentos;
    ...
    public Collection<CompraProtegidaEntity> getPagamentos() {
        return pagamentos;
    }

    public void setPagamentos(Collection<CompraProtegidaEntity> pagamentos) {
